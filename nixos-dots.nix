...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home.file.".config/kitty/kitty-colors.conf".source =
      config.lib.file.mkOutOfStoreSymlink ./config/kitty/kitty-colors.conf;
    ...
    home.file.".config/wallust/wallust.toml".source =
      config.lib.file.mkOutOfStoreSymlink ./config/wallust/wallust.toml;
    ...
    home.file.".config/hypr/UserConfigs".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/UserConfigs;
    home.file.".config/hypr/UserScripts".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/UserScripts;
    home.file.".config/hypr/hypridle.conf".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/hypridle.conf;
    home.file.".config/hypr/hyprlock.conf".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/hyprlock.conf;
    home.file.".config/hypr/initial-boot.sh".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/initial-boot.sh;
    ...
    home.file.".config/hypr/pyprland.toml".source =
      config.lib.file.mkOutOfStoreSymlink ./config/hypr/pyprland.toml;

    home.file.".config/wal/templates/colors-hyprland.conf".source =
      config.lib.file.mkOutOfStoreSymlink ./config/wal/templates/colors-hyprland.conf;
    home.file.".config/wal/templates/obsidian.css".source =
      config.lib.file.mkOutOfStoreSymlink ./config/wal/templates/obsidian.css;

    home.file.".config/wal/templates/spicetify.ini".source =
      config.lib.file.mkOutOfStoreSymlink ./config/wal/templates/spicetify.ini;
    home.file.".config/spicetify/config-xpui.ini".source =
      config.lib.file.mkOutOfStoreSymlink ./config/spicetify/config-xpui.ini;
