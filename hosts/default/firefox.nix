...
let
  ...
  darkreaderManifest = {
    ...
    path = "${../../config/darkreader}/index.js";
    type = "stdio";
  };
in
{
  ...
  # config.xdg.configFile."vimfx/config.js".source = ../../config/firefox/vimfx.js;
  # config.xdg.configFile."vimfx/frame.js".text = "";

  # config.xdg.configFile."wal/templates/userContent.css".source = ../../config/firefox/userContent.css;
  ...
  #   };
    ...
    # ".mozilla/firefox/default/chrome/layout.css".source = ../../config/firefox/twoline.css;
